...
class Person {
	...
	public static function operate($client, array $get = array(), array $post = array()) {
		$attributes = array("GET" => $get, "POST" => $post);
		$json = $client->getJSONObject("list.person", "operate", $attributes);
		return $json;
	}
	...
	public static function get($client, array $get = array(), array $post = array()) {
		$attributes = array("GET" => $get, "POST" => $post);
		$json = $client->getJSONObject("list.person", "get", $attributes);
		return $json;
	}
	public static function dismissAll($client, array $get = array(), array $post = array()) {
		$attributes = array("GET" => $get, "POST" => $post);
		$json = $client->getJSONObject("list.person", "dismissAll", $attributes);
		return $json;
	}
}
?>