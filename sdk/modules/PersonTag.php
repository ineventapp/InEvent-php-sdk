...
class Tag {
	public static function bind($client, array $get = array(), array $post = array()) {
		...
		$json = $client->getJSONObject("person.tag", "bind", $attributes);
		return $json;
	}
	public static function dismiss($client, array $get = array(), array $post = array()) {
		$attributes = array("GET" => $get, "POST" => $post);
		$json = $client->getJSONObject("person.tag", "dismiss", $attributes);
		return $json;
	}
	public static function find($client, array $get = array(), array $post = array()) {
		$attributes = array("GET" => $get, "POST" => $post);
		$json = $client->getJSONObject("person.tag", "find", $attributes);
		return $json;
	}
}
?>